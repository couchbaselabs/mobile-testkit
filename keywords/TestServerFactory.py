...
class TestServerFactory:
    ...
    def validate_platform(platform):
        valid_platforms = ["android", "ios", "net-mono", "net-msft", "net-uwp", "xamarin-android", "xamarin-ios", "java", "javaws-msft", "javaws-linux"]
