...
class TestServerAndroid(TestServerBase):
    ...
    def download(self, version_build=None):
        ...
        new_url = "https://latestbuilds.service.couchbase.com/builds/latestbuilds/couchbase-lite-android/3.2.0/{}/CBLTestServer-Android-3.2.0-{}-enterprise-release.apk".format(build, build)
