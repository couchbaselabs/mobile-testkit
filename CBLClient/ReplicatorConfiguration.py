...
class ReplicatorConfiguration(object):
    ...
    def configure(self, source_db, target_url=None, target_db=None, replication_type="push_pull", continuous=False,
                  channels=None, documentIDs=None, replicator_authenticator=None, headers=None, max_timeout_interval=None, retries=None, decryptor=None, encryptor=None):
        args = Args()
        ...
        if decryptor is not None:
            args.setMemoryPointer("decryptor", decryptor)
