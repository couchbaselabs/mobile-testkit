...
# Test 3
# 3 IR / 1 IW
python libraries/provision/create_and_instantiate_cluster.py --stackname="SethPerfStack" --num-servers=3 --server-type="c3.2xlarge" --num-sync-gateways=4 --sync-gateway-type="c3.2xlarge" --num-gatlings=3 --gatling-type="c3.2xlarge"
python libraries/provision/generate_ansible_inventory_from_aws.py --stackname="SethPerfStack" --targetfile="aws_perf_config"
# Edit provisioning_config to reflect the number of writers you require
python libraries/provision/provision_cluster.py --server-version=4.1.0 --sync-gateway-version=1.2.0-XX --install-deps
...
# Test 8
# 3 IR / 2 IW
python libraries/provision/create_and_instantiate_cluster.py --stackname="SethPerfStack" --num-servers=3 --server-type="c3.2xlarge" --num-sync-gateways=5 --sync-gateway-type="c3.2xlarge" --num-gatlings=3 --gatling-type="c3.2xlarge"
python libraries/provision/generate_ansible_inventory_from_aws.py --stackname="SethPerfStack" --targetfile="aws_perf_config"
# Edit provisioning_config to reflect the number of writers you require
python libraries/provision/provision_cluster.py --server-version=4.1.0 --sync-gateway-version=1.2.0-XX --install-deps
