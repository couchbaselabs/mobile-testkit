...
@pytest.mark.replication
@pytest.mark.parametrize("sg_conf_name, num_of_docs", [
    # pytest.param('listener_tests/multiple_sync_gateways', 10, marks=pytest.mark.sanity), https://issues.couchbase.com/browse/CM-1185
...
def test_multiple_sgs_with_CBLs(params_from_base_test_setup, setup_customized_teardown_test, sg_conf_name, num_of_docs):
    ...
    elif liteserv_platform in ["java-macosx", "java-msft", "java-ubuntu", "java-centos", "java-debian", "javaws-macosx", "javaws-msft", "javaws-ubuntu", "javaws-centos"]:
