...
def test_transactions_insert_replace_remove_rollback(params_from_base_test_setup):
    ...
    # example: java -cp transaction-performer.jar com.couchbase.transaction clusterip=192.168.33.10 bucket=data-bucket-1608172398.613448 operationDocids=insert-doc1,replace-doc8,remove-doc9 doccontent='{"uni_key_id": "transaction-sync-id2", "content": "doc3", "channels": ["TRANSACTIONS"]}'
