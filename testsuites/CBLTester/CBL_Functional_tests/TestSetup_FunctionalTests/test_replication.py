...
def test_push_replication_with_backgroundApp(params_from_base_test_setup, num_docs, need_attachments,
    ...
    if liteserv_platform in ["java-debian", "java-macosx", "java-msft", "java-ubuntu", "java-centos", "javaws-macosx", "javaws-msft", "javaws-ubuntu", "javaws-centos"] or 'c' in liteserv_platform:
