...
def test_delta_sync_replication(params_from_base_test_setup, num_of_docs, replication_type, file_attachment, continuous):
    ...
    print "doc_reads_bytes after 1st update is ", doc_reads_bytes1
    print "doc_writes_bytes  after 1st update is ", doc_writes_bytes1
    ...
    print "doc_reads_bytes1 is ", doc_reads_bytes2
    print "doc_writes_bytes1  is ", doc_writes_bytes2
    if replication_type == "push":
