...
def run_perf_test(number_pullers, number_pushers, use_gateload, gen_gateload_config, test_id):
    ...
    cluster = Cluster()
    mode = cluster.reset("resources/sync_gateway_configs/performance/sync_gateway_default_performance.json")
