...
def upgrade_server_cluster(servers, primary_server, secondary_server, server_version, server_upgraded_version, server_urls, cluster_config, cbs_platform, toy_build=None):
    ...
    for server in servers:
        ...
        log_info("Waiting for the server {} to be ready".format(server.host))
        server.wait_for_ready_state()
    ...
    log_info("Waiting for the server {} to be ready".format(primary_server.host))
    primary_server.wait_for_ready_state()
