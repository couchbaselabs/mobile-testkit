...
from keywords.exceptions import FeatureSupportedError, ProvisioningError
from keywords.SyncGateway import (sync_gateway_config_path_for_mode,
                                  validate_sync_gateway_mode)
from keywords.tklogging import Logging
from keywords.utils import (check_xattr_support, clear_resources_pngs,
                            log_info, version_is_binary)
from libraries.NetworkUtils import NetworkUtils
from libraries.testkit import cluster
from utilities.cluster_config_utils import (
    get_load_balancer_ip, persist_cluster_config_environment_prop)


# This will be called once at the beggining of the execution in the 'tests/version_vectors' directory
...
def params_from_base_suite_setup(request):
    ...
    cluster_config = "{}/2sg_2cbs".format(keywords.constants.CLUSTER_CONFIGS_DIR)
