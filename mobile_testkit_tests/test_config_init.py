...
@pytest.mark.parametrize("sync_gateway_config, buckets, mode", [
    ...
    ("multiple_dbs_unique_data_unique_index_cc.json", ['data-bucket-1', 'data-bucket-2'], "cc"),
    # ("multiple_dbs_unique_data_unique_index_di.json", ['index-bucket-2', 'data-bucket-1', 'index-bucket-1', 'data-bucket', 'data-bucket-2'], "di"),
