...
def test_multiple_db_unique_data_bucket_unique_index_bucket(cluster):
    ...
    verify_changes(db_one_users, expected_num_docs=num_docs_per_user * num_db_users, expected_num_updates=0, expected_docs=db_cache_docs)
    verify_changes(db_two_users, expected_num_docs=num_docs_per_user * num_db2_users, expected_num_updates=0, expected_docs=db2_cache_docs)
...
def test_multiple_db_single_data_bucket_single_index_bucket(cluster):
    ...
    verify_changes(all_users, expected_num_docs=1000, expected_num_updates=0, expected_docs=cached_docs_from_all_users)
