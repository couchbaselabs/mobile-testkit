...
if __name__ == "__main__":
    ...
    try:
        ...
        print("Make sure CLUSTER_CONFIG is defined and pointing to the configuration you would like to provision while installing prometheus", ke)
        raise KeyError("CLUSTER_CONFIG not defined. Unable to provision cluster while installing prometheus.")
