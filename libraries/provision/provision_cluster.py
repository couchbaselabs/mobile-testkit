...
def provision_cluster(cluster_config, couchbase_server_config, sync_gateway_config, sg_ssl=False, sg_lb=False, cbs_ssl=False, use_views=False,
                      ...
                      sa_installer_type="msi", cbs_ce=False, aws=False, skip_couchbase_provision=False, custom_build=None, code_coverage=None):
    ...
    clean_cluster(cluster_config, skip_couchbase_provision=skip_couchbase_provision, sg_platform=sg_platform, cbs_platform=cbs_platform)
